    ...
    >
      <div className="  main-container relative ">
        ...
        <div className="flex flex-col items-center justify-center text-center w-full mt-18 md:mt-0">
          <p className="font-montserrat font-black leading-[110%] max-w-[100%] mx-auto text-center text-[30px] font-[900] md:text-[48px] xl:text-[80px]">
          ...
          <div className="flex flex-col items-center justify-center mt-1 md:mt-35 xl:mt-5 md:gap-5 xl:gap-1">
            ...
            <div className="hidden md:flex flex-col items-center justify-between text-center bg-[#0E56D7] rounded-[20px]
              ...
              <p className="text-[10px] font-montserrat font-black font-[700] md:text-[20px] xl:text-[30px]">
                Больше 10000 пользователей
              </p>
              <p className="text-[18px] font-montserrat  mb-1 font-[500] xl:text-[20px]">
                постоянно играют с нами
              </p>
              <button onClick={handleScroll} className="text-[20px] bg-white text-[#0E56D7] w-[104px] h-[19px] flex items-center justify-center rounded-[6px] font-[700] lg:text-[20px] lg:w-[250px] mx-auto lg:h-[45px] cursor-pointer">
                Прочитать отзывы
              </button>
            </div>
            ...
            <div className="flex gap-15 lg:gap-[23rem] mt-[20px] sm:mt-[20px]">
              ...
              <div className="hidden md:flex flex-col items-center justify-between text-center bg-[#0E56D7] rounded-[20px]
                ...
                <p className="text-[18px] mb-1 font-montserrat font-[500] xl:text-[20px]">
                  по низкой цене
                </p>
